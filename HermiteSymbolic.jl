...
Symbolics.substitute(herm::Hermite, syms1::Union{Vector{Num},Tuple{Num}}, syms2::Union{Vector{Num},Tuple{Num}})::Hermite = substitute(herm, Dict(zip(syms1,syms2)))
Symbolics.substitute(herm::Num, syms1::Union{Vector{Num},Tuple{Num}}, syms2::Union{Vector{Num},Tuple{Num}})::Num = substitute(herm, Dict(zip(syms1,syms2)))
